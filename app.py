...
#import the ml model
#model.pkl is in binary format so we read/load as read_binary format
#literals me hum options dete hai ki user ky ky ho skta hai, ya phhir chun skta hai
with open("model.pkl", 'rb') as f: #rb -> read_binary
    model = pickle.load(f)
...
class UserInput(BaseModel):
    ...
    weight :Annotated[int, Field(...,  gt=0, description='Weight of the User in Kg' )]
